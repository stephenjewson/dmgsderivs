...
cat("############################################################\n")
#
cat("#' The first derivative of the densityfor WAIC\n")
cat("#' @returns Vector\n")
cat("#' @inheritParams manf\n")
cat(
...
###cat("#' @inheritParams manf\n")
###cat(
###"lst_p1k3_p1fa=function(x,t0,v1,v2,v3,kdf){
###	vf=Vectorize(lst_p1k3_pd,\"x\")
###	p1=vf(x,t0,v1,v2,v3,kdf)
###	return(p1)
###}\n"
###)
cat("############################################################\n")
...
###cat("#' @inheritParams manf\n")
###cat(
###"lst_p1k3_p2fa=function(x,t0,v1,v2,v3,kdf){
###	nx=length(x)
