...
library(Deriv)
#
f=function(x,t1,t2,t3,v1,v2,v3,v4,v5,v6){-v3-t2*v4-(1+1/(v5+t3*v6))*log(1+(v5+t3*v6)*(x-v1-t1*v2)/exp(v3+t2*v4))-
		(1+(v5+t3*v6)*(x-v1-t*v2)/exp(v3+t2*v4))^(-1/(v5+t3*v6))}
gev_p123_logfdd=Deriv(f,c("v1","v2","v3","v4","v5","v6"),nderiv=2)
gev_p123_logfddd=Deriv(f,c("v1","v2","v3","v4","v5","v6"),nderiv=3)
#
