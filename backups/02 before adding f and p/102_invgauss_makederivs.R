...
f=function(x,v1,v2){0.5*log(v2)-0.5*log(2*pi)-1.5*log(x)-v2*(x-v1)^2/(2*v1*v1*x)}
invgauss_logfdd=Deriv(f,c("v1","v2"),nderiv=2)
invgauss_logfddd=Deriv(f,c("v1","v2"),nderiv=3)
#
