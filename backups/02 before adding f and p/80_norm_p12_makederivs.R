...
# mu=v1 + b v2
# sd=exp(v3+d v4)
f=function(x,t1,t2,v1,v2,v3,v4){-0.5*log(2*pi)-v3-t2*v4-(x-v1-t1*v2)^2/(2*exp(2*v3+2*t2*v4))}
norm_p12_logfdd=Deriv(f,c("v1","v2","v3","v4"),nderiv=2)
norm_p12_logfddd=Deriv(f,c("v1","v2","v3","v4"),nderiv=3)
#
