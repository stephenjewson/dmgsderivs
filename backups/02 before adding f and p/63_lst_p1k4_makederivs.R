...
f=function(x,t,v1,v2,v3,v4){log(gamma(0.5*(v4+1)))-0.5*log(pi)-0.5*log(v4)-
		log(v3)-log(gamma(0.5*v4))-0.5*(v4+1)*log(1+(x-v1-t*v2)^2/(v4*v3*v3))}
lst_p1k4_logfdd=Deriv(f,c("v1","v2","v3"),nderiv=2)
lst_p1k4_logfddd=Deriv(f,c("v1","v2","v3"),nderiv=3)
#
