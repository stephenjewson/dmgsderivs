...
library(Deriv)
#
f=function(x,t,v1,v2,v3){-0.5*log(2*pi)-log(v3)-log(x)-(log(x)-v1-t*v2)^2/(2*v3*v3)}
lnorm_p1_logfdd=Deriv(f,c("v1","v2","v3"),nderiv=2)
lnorm_p1_logfddd=Deriv(f,c("v1","v2","v3"),nderiv=3)
#
