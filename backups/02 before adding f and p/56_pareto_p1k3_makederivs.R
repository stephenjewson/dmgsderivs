...
library(Deriv)
#
f=function(x,t,v1,v2,v3){-v1-t*v2+exp(-v1-t*v2)*log(v3)-(exp(-v1-t*v2)+1)*log(x)}
pareto_p1k3_logfdd=Deriv(f,c("v1","v2"),nderiv=2)
pareto_p1k3_logfddd=Deriv(f,c("v1","v2"),nderiv=3)
#
