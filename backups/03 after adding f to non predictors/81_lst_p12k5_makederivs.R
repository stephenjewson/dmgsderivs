...
logf=function(x,t1,t2,v1,v2,v3,v4,v5){log(gamma(0.5*(v5+1)))-0.5*log(pi)-0.5*log(v5)-
		v3-t2*v4-log(gamma(0.5*v5))-0.5*(v5+1)*log(1+(x-v1-t1*v2)^2/(v5*exp(2*v3+2*t2*v4)))}
lst_p12k5_logfdd=Deriv(logf,c("v1","v2","v3","v4"),nderiv=2)
lst_p12k5_logfddd=Deriv(logf,c("v1","v2","v3","v4"),nderiv=3)
#
